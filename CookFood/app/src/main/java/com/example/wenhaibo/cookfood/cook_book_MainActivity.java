package com.example.wenhaibo.cookfood;
...
public class cook_book_MainActivity extends Activity {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == Change) {
                ...
                tv_show_material.setTextColor(getResources().getColor(R.color.welcome_bgc));
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            Intent i2 = new Intent(cook_book_MainActivity.this, IndexSuperActivity.class);
            startActivity(i2);
            finish();
