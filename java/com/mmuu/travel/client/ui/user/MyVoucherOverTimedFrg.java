...
public class MyVoucherOverTimedFrg extends MFBaseFragment implements View.OnClickListener, PublicRequestInterface {
    ...
    private void initData(boolean isshow) {
        ...
        params.addBodyParameter("type", "invalid");
    ...
    private void initView() {
        ...
        adp = new VoucherAdp(mContext, voucherVOs, "invalid");
